...
export type EventType = 'game.started' | 'player.joined' | 'player.renamed' | 'transfer' | 'transfer.reversed' | 'player.eliminated' | 'settlement.started' | 'settlement.submitted' | 'settlement.dismissed' | 'game.ended' | 'turn.advanced' | 'player.jailed' | 'player.released' | 'request.created' | 'request.resolved';
